<!-- Edit -->
<div class="modal fade" id="edit{{$sip6->id}}" tabindex="-1" role="dialog" aria-labelledby="editModal{{$sip6->id}}" aria-hidden="true">
...
<!-- Delete -->
<div class="modal fade" id="delete{{ $sip6->id }}" tabindex="-1" role="dialog" aria-labelledby="deleteModal{{ $sip6->id }}" aria-hidden="true">
