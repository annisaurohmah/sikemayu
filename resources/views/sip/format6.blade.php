 <!-- Tab 6: Format 6 -->
 <div class="tab-pane fade table-responsive" id="format6" role="tabpanel" aria-labelledby="format6-tab">
     <div class="card">
         <div class="card-body">
             <div class="table-responsive">
                 <!-- Log on to codeastro.com for more projects! -->
                 <table id="datatable-buttons-6" class="table table-striped table-hover table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
