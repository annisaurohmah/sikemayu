<!-- Tab 5: Format 5 -->
<div class="tab-pane fade table-responsive" id="format5" role="tabpanel" aria-labelledby="format5-tab">
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <!-- Log on to codeastro.com for more projects! -->
                <table id="datatable-buttons-5" class="table table-striped table-hover table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
