<!-- Content Tab -->
<div class="tab-pane fade table-responsive" id="pokja" role="tabpanel">
    ...
    <table id="table-pokja" class="table table-striped table-hover table-bordered dt-responsive nowrap">
        <thead class="thead-dark">
            <tr>
                ...
                <th data-priority="5">Dokumentasi</th>
                <th data-priority="6">Aksi</th>
            </tr>
        </thead>
        <tbody>
                @foreach($pokjaList as $index => $dokumentasi)
                <tr>
                    <td>{{ $index + 1 }}</td>
                    ...
                    <td>
                        <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editPokja{{ $pokja->pokja_id }}">
                            <i class="fa fa-edit"></i> Edit
                        </button>
                        <form action="{{ route('pokja.delete', $pokja->pokja_id) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus dokumentasi ini?')">
                            @csrf
                            @method('DELETE')
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalDokum"><b>Tambah Data Dokumentasi Kegiatan - Pokja</b></h5>
            ...
            <div class="modal-body">
                <form id="form-add-dokumentasi" method="POST" action="{{ route('pokja.store') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="posyandu_id" value="{{ 'pokja1- }}" />
